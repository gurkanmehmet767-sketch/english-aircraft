...
class _FloatingXP {
  ...
  bool get isExpired => DateTime.now().difference(createdAt).inMilliseconds > 1500;
}
...
class _GameScreenState extends State<GameScreen> with TickerProviderStateMixin {
  ...
  // Game Settings
  int _difficulty = 1; // 0: Easy (3-5 chars), 1: Medium (6-8 chars), 2: Hard (9+ chars)
  int _score = 0;
  int _wordsPlayed = 0;
  ...
  void _checkWord() {
    if (_controller.text.toUpperCase() == _currentWord) {
      ...
      int difficultyBonus = (_difficulty + 1) * 5; // Kolay: 5, Orta: 10, Zor: 15
      int timeBonus = (_timeLeft ~/ 5); // Kalan süre bonusu
      int completionBonus = difficultyBonus + timeBonus;
      
      if (_showHint) completionBonus = (completionBonus * 0.7).round(); // Hint penalty
  ...
  Widget build(BuildContext context) {
    ...
    final primaryNeon = isDark ? const Color(0xFF00D4FF) : const Color(0xFF0099CC);
    final secondaryNeon = isDark ? const Color(0xFF00FF88) : const Color(0xFF00CC66);
    final warningNeon = const Color(0xFFFF6B35);
    final bgColor = isDark ? const Color(0xFF0A1628) : const Color(0xFFF0F4F8);
    
    Color currentGlow = _isCorrect ? secondaryNeon : (_isWrong ? warningNeon : primaryNeon);
    ...
    return Scaffold(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: primaryNeon.withValues(alpha: 0.2)),
                ),
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    ...
                    Column(
                      children: [
                        Icon(Icons.check_circle, color: secondaryNeon, size: 20),
                        const SizedBox(height: 4),
                        Text(
                    ...
                    Column(
                      children: [
                        Icon(Icons.speed, color: _getDifficultyColor(isDark), size: 20),
                        const SizedBox(height: 4),
                        GestureDetector(
                          onTap: () {
                            setState(() {
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: _getDifficultyColor(isDark).withValues(alpha: 0.2),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  border: Border.all(color: primaryNeon.withValues(alpha: 0.3), width: 1),
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          // Outer glow
                          BoxShadow(
                            color: currentGlow.withValues(alpha: _glowAnimation.value * 0.5),
                            blurRadius: 30,
                            spreadRadius: 5,
                          ),
                          // Inner glow
                          BoxShadow(
                            color: currentGlow.withValues(alpha: _glowAnimation.value * 0.3),
                            blurRadius: 15,
                            spreadRadius: 2,
                          ),
                        ],
                ...
                child: _isCorrect
                    ? Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          borderRadius: BorderRadius.circular(12),
                          border: Border.all(color: secondaryNeon, width: 1.5),
                        ),
                        child: Row(
                          mainAxisSize: MainAxisSize.min,
                          children: [
                            Icon(Icons.rocket_launch, color: secondaryNeon, size: 24),
                            const SizedBox(width: 10),
                            Text(
                              'CORRECT! +20 XP',
                              style: TextStyle(
                    ...
                    : _isWrong
                        ? Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              borderRadius: BorderRadius.circular(12),
                              border: Border.all(color: warningNeon, width: 1.5),
                            ),
                            child: Row(
                              mainAxisSize: MainAxisSize.min,
                              children: [
                                Icon(Icons.warning_amber, color: warningNeon, size: 24),
                                const SizedBox(width: 10),
                                Text(
                                  'TRY AGAIN!',
                                  style: TextStyle(
              ...
              Row(
                ...
                children: [
                  ...
                  if (!_showHint)
                    TextButton.icon(
                      onPressed: _useHint,
                      icon: Icon(Icons.lightbulb_outline, color: Colors.amber.withValues(alpha: 0.7)),
                      label: Text(
                        'İPUCU',
                        style: TextStyle(
                  ...
                  TextButton.icon(
                    ...
                    icon: Icon(Icons.skip_next, color: primaryNeon.withValues(alpha: 0.7)),
                    label: Text(
                      'KELİME GEÇ',
                      style: TextStyle(
      ...
      ..._floatingXPs.map((floatingXP) {
        final age = DateTime.now().difference(floatingXP.createdAt).inMilliseconds;
