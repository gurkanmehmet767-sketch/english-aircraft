...
void main() {
  ...
  buffer.writeln("  League(name: 'Bronz', xp: 0, colors: ['#CD7F32'], desc: 'Başlangıç'),");
  buffer.writeln("  League(name: 'Gümüş', xp: 500, colors: ['#C0C0C0'], desc: 'Gelişen'),");
  buffer.writeln("  League(name: 'Altın', xp: 1500, colors: ['#FFD700'], desc: 'İyi'),");
  buffer.writeln("  League(name: 'Platin', xp: 3000, colors: ['#E5E4E2'], desc: 'Çok iyi'),");
  buffer.writeln("  League(name: 'Elmas', xp: 5000, colors: ['#B9F2FF'], desc: 'Mükemmel'),");
  buffer.writeln("  League(name: 'Şampiyon', xp: 10000, colors: ['#FF6B6B'], desc: 'Uzman'),");
  buffer.writeln('];');
  buffer.writeln('');
